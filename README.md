...
`read-aloud` is an Agent Skill that synthesizes text through VoiceFlow TTS,
...
Restart Codex if the Skill is not discovered immediately. Node.js 20 or newer
is required.
...
Use the [VoiceFlow dashboard](https://audioflow123.com/dashboard) to add prepaid
